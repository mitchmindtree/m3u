...
fn empty_extinf_cannot_be_parsed() {
    assert_eq!(read_extinf(""), None);
}

#[test]
fn extinf_may_contain_1_prop() {
    assert_eq!(
        read_extinf("#EXTINF:10 a=\"\",Toto"),
        Some(IptvExtInf {
            name: "Toto".to_string(),
            duration_secs: 10.0,
            iptv_props: iptv!("a" = "")
...
fn property_value_may_contain_quotes() {
    use crate::iptv;
    assert_eq!(
        read_extinf(r#"#EXTINF:10 a="var "a"",Toto"#),
        Some(IptvExtInf {
            name: "Toto".to_string(),
            duration_secs: 10.0,
...
fn property_value_may_contain_commas() {
    use crate::iptv;
    assert_eq!(
        read_extinf(r#"#EXTINF:10 a="b,c",Toto"#),
        Some(IptvExtInf {
            name: "Toto".to_string(),
            duration_secs: 10.0,
